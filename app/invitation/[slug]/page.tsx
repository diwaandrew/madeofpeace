...
import { MailSearch, MapPinned, Send } from "lucide-react";
      ...
      <div>
          <div className="flex justify-center items-center h-screen aurora">
            <div className="my-8 flex flex-col items-center text-center bg-no-repeat bg-center ">
              ...
              >
                <MailSearch color="black" size={24} />
                Buka Undangan
              </button>
            </div>
          </div>
        ...
        <section className="dark-section" id="tanggal">
          <div className="container">
            <div className="text-center">
              ...
              <div className="mx-auto flex flex-col items-center py-4" data-aos="fade-up" data-aos-duration="1500">
                <Link
        ...
        <section className="w-full" id="ucapan">
          <div className="flex flex-col items-center">
            <div className="w-full mx-8 border rounded-md shadow p-3">
              <h1 className="text-center font-sacramento my-4 text-4xl md:text-8xl py-3">Ucapan & Doa</h1>
              ...
              <div className="my-4 flex flex-col gap-2">
                <label
                  htmlFor="form-kehadiran"
                  className="text-sm"
                  id="label-kehadiran"
                >
                  Kehadiran
                </label>
                <select className="px-4 py-2 border text-sm text-white rounded-md bg-transparent" id="form-kehadiran">
            ...
            {/* <nav className="d-flex justify-content-center mb-0">
              <ul className="pagination mb-0">
                ...
                <li className="page-item disabled">
                  <span className="page-link text-light" id="page">
                    1
                  </span>
                </li>
